...
export const transferMaticRequest = ({ fromPrivateKey, toPublicKey, amount}) => ({
...
export const transferMaticSuccess = ({ fromPrivateKey, toPublicKey, amount, transactionHash }) => ({
...
export const transferRubleRequest = ({ fromPrivateKey, toPublicKey, amount }) => ({
...
export const transferRubleSuccess = ({ fromPrivateKey, toPublicKey, amount, transactionHash}) => ({
...
export const transferNftRequest = ({ fromPrivateKey, toPublicKey, tokenId }) => ({
...
export const transferNftSuccess = ({ fromPrivateKey, toPublicKey, tokenId, transactionHash }) => ({
...
export const walletBalanceSuccess = ({ publicKey, maticAmount, coinsAmount }) => ({
...
export const generateNftSuccess = ({ transactionHash, toPublicKey, uri, nftCount}) => ({
